...
- **Separate Upload Flow**: Dedicated landing page for file upload.
...
- **Modular Design**: 
    - `core/`: Business logic and parsers (e.g., `core/gen1`, `core/gen2` planned).
    - `components/`: Reusable UI elements.
    - `pages/`: Application screens (Upload, Editor).
    - `data/`: Static text resources.
